...
class Courseclass(db.Model):
    ...
    teachers = db.relationship('User', secondary=teacher_class, back_populates='courseclasses', lazy='dynamic')
    students = db.relationship('User', secondary=student_class, back_populates='courseclasses', lazy='dynamic')
